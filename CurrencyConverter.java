...
public class CurrencyConverter {
    ...
    private void initialize() {
        ...
        t2.setFont(new Font("Times", Font.BOLD, 23));
        t2.setColumns(10);
        ...
        lblNewLabel_1.setFont(new Font("Times", Font.BOLD, 23));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (firstCountry.getSelectedIndex() == 0 || secondCountry.getSelectedIndex() == 0
                    ...
                    JOptionPane.showMessageDialog(null,
                            "You must have to select both countries and must give an input amount to perform operation",
                            "Error Message",
                ...
                switch (firstCountry.getSelectedItem().toString()) {
                    ...
                    case "India":
                        ...
                        break;
                    case "Philippine":
                        amountInPounds = amountToChange / Phillipine_Pisco;
                        break;
                    case "Pakistan":
                ...
                switch (secondCountry.getSelectedItem().toString()) {
                    ...
                    case "Indonesia":
                        ...
                        break;
                    case "Philippine":
                        amountChanged = amountInPounds * Phillipine_Pisco;
                        break;
                    case "Pakistan":
        ...
        btnNewButton.setFont(new Font("Times", Font.BOLD, 23));
        btnNewButton.setBounds(79, 367, 137, 44);
        frame.getContentPane().add(btnNewButton);

        JButton btnReset = new JButton("Reset");
        btnReset.setForeground(new Color(179, 59, 0));
        ...
        btnReset.setFont(new Font("Times", Font.BOLD, 23));
        btnReset.setBounds(300, 367, 110, 44);
        frame.getContentPane().add(btnReset);

        JButton btnExit = new JButton("Exit");
        btnExit.setForeground(new Color(255, 25, 25));
        btnExit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                System.exit(0);
            }
        });
        btnExit.setFont(new Font("Times", Font.BOLD, 23));
